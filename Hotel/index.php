...
<html>
    <head>
        <meta charset="UTF-8">
        <title> Бронь кімнат у готелі (HTML5/JavaScript/PHP)</title>
        <!-- demo stylesheet -->
    ...
    <body>
            <div id="header">
                <div class="bg-help">
                    <div class="inBox">
                        <h1 id="logo"> Бронь кімнат у готелі (HTML5/JavaScript/PHP)</a></h1>
                        <p id="claim">
                        Веб-застосунок з JavaScript/AJAX/HTML5/jQuery</p>
                        <hr class="hidden" />
                    </div>
                </div>
            </div>
                ...
                <div class="space">
                    ...
                    <select id="filter">
                     ...
                     &nbsp;&nbsp;
                        ...
                        <button id="add-room">Додати кімнати</button>

                        <div class="toolbar-separator"></div>
                    <div class="space">
                        Початок заїзду: <span id="start"></span> <a href="#" onclick="picker.show(); return false;">Вибір</a> 
                        Період: 
                        <select id="timerange">
                            <option value="week">Тиждень</option>
                            <option value="2weeks">2 тижня</option>
                            <option value="month" selected>Місяць</option>
                            <option value="2months">2 місяця</option>
                        </select>
                        <label for="autocellwidth"><input type="checkbox" id="autocellwidth">Автоширина комірок</label>
            <div class="toolbar-separator"></div>
  ...
  if ('serviceWorker' in navigator) {
      navigator.serviceWorker.register('/sw.js').then((reg) => 
       ...
       console.log('Service Worker registration failed:', error)
            ...
            <footer>
  <address>texhapppb.wd.nubip.edu.ua &copy;</address>
 </footer>
 <script>
if (‘serviceWorker’ in navigator) {
